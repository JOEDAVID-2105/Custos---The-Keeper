          ...
          {mode === 'signup' && (
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-transparent border border-slate-200 dark:border-white/10 p-4 focus:border-indigo-500 outline-none transition-all font-noto text-slate-900 dark:text-white"
                placeholder="..."
                required
              />
            </div>
      ...
      <div className="mt-8 space-y-4 text-center">
        {mode === 'login' && (
          <button 
            ...
            className="w-full text-[10px] tracking-widest text-slate-400 dark:text-white/30 hover:text-slate-900 dark:hover:text-white transition-all uppercase font-bold font-noto"
          >
            {t.newGuardianship}
          </button>
        )}
