...
export const PortraitSelection: React.FC<PortraitSelectionProps> = ({ 
  ...
  // Fix: Added 'key' to the prop type definition to satisfy TypeScript when rendering in a map.
  const PortraitGrid = ({ title, items, type, subtitle }: { title: string, subtitle: string, items: string[], type: 'men' | 'women' | 'mixed', key?: string }) => (
