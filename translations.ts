...
export const translations = {
  en: {
    ...
    theKeeper: "CUSTOS SOVEREIGN PROTOCOL",
    inflow: "INFLOW",
    outflow: "OUTFLOW",
    balance: "BALANCE",
    ...
    about: {
      ...
      update1: "v3.0: CUSTOS SOVEREIGN PRIME",
  ...
  ta: {
    ...
    theKeeper: "CUSTOS SOVEREIGN நெறிமுறை",
    inflow: "வரவு",
    outflow: "செலவு",
    balance: "மீதம்",
    ...
    about: {
      ...
      update1: "v3.0: CUSTOS SOVEREIGN பிரைம்",
    ...
    auth: {
      ...
      denied: "காவலன் அணுகலை மறுபடி மறுத்துவிட்டார்.",
